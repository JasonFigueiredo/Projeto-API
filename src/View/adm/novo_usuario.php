                        ...
                        <form action="novo_usuario.php" method="post" id="formCad">
                            ...
                            <div class="row" id="divDadosUsuario" style="display: none;">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label>E-mail:</label>
                                        <input type="email" class="form-control obg" id="email" name="email" placeholder="Digite o E-mail" oninput="formatarEmail('email')" onblur="VerificarEmailDuplicado()" style="text-transform: lowercase;">
                                    </div>
                                </div>
                            </div>
